...
3. 訊かれる2つの値を入れる
   ...
   - `GRAPE_ADMIN_PASSWORD` — **必須**。これが無いと、公開URLからは全部503になります
4. 初回デプロイ後、割り当てられた `https://....onrender.com` を
   `/settings` の「訪問データの受け取り先」に入れて保存する
5. 同じ画面の「計測用のコード」をコピーして、自分のサイトに貼る
